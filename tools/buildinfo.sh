...
echo "ro.build.display.id=K8C_V1.02"
...
echo "ro.product.model=K8C"
echo "ro.product.brand=Wherecom"
echo "ro.product.name=K8C"
echo "ro.product.device=Android"
echo "ro.product.board=$PRODUCT_NAME"
echo "ro.product.cpu.abi=$TARGET_CPU_ABI"
if [ -n "$TARGET_CPU_ABI2" ] ; then
  echo "ro.product.cpu.abi2=$TARGET_CPU_ABI2"
fi
echo "ro.product.manufacturer=Wherecom"
